...
public final class BillUtils {
    ...
    2. Implement different functions that perform operation with org.example.Bill objects.
     */
    ...
    // TODO: Create a function that receives a org.example.Bill instance and returns the total amount of its products [ITERATIVE]
    ...
    // TODO: Create a function that receives a org.example.Bill instance and returns the total amount of its products [STREAMS]
    ...
    // TODO: Create a function that receives a org.example.Bill instance and returns the number of products that start with the letter A [ITERATIVE]
